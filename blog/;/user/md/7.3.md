...
info 可以拷贝其他JS代码到下方文本框中进行加亮演示。

<textarea id="codebox" style="font:12px/1.5 monaco,Helvetica,Tahoma,Arial,宋体,sans-serif;border:1px solid #3C78B5;padding:3px 8px;margin:8px 0;width:98%;background:#eee;resize:none;outline:none;" rows="14">
function $for(new_){
	var a = 100, //注释而已
