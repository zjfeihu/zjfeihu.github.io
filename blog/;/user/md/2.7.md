...
本文将对HTTP协议进行详细的实例讲解，内容较多，希望大家耐心看。也希望对大家的开发工作或者测试工作有所帮助。
使用Fiddler工具非常方便地捕获HTTP Request和HTTP Response，  关于Fiddler工具的用法，请看我另一篇博客
xlink[『Fiddler 教程』]http://www.cnblogs.com/TankXiao/archive/2012/02/06/2337728.html

###阅读目录
<ol>
    <li><a href="#whathttp">什么是HTTP协议</a></li>
    <li><a href="#threeconcept">Web服务器，浏览器，代理服务器</a></li>
    <li><a href="#urlexplain">URL详解</a></li>
    <li><a href="#statelesshttp">HTTP协议是无状态的</a></li>
    <li><a href="#ManyRequest">打开一个网页需要浏览器发送很多次Request</a></li>
    <li><a href="#httpmeessagestructe">HTTP消息的结构</a></li>
    <li><a href="#getpost">Get和Post方法的区别</a></li>
    <li><a href="#statecode">状态码</a></li>
    <li><a href="#httprequestheader">HTTP Request header</a></li>
    <li><a href="#httpresponseheader">HTTP Response header</a></li>
    <li><a href="#statelessalive">HTTP协议是无状态的和Connection: keep-alive的区别</a></li>
</ol>
...
##打开一个网页需要浏览器发送很多次Request<a name="ManyRequest"></a>
...
HTTP/version-number表示HTTP协议的版本号，  status-code 和message 请看下节<a href="#statecode">[状态代码]</a>的详细解释.
...
info 提示：如果你不想使用本地缓存可以用Ctrl+F5 强制刷新页面
...
xlink[HTTP协议 (一) HTTP协议详解]http://www.cnblogs.com/TankXiao/archive/2012/02/13/2342672.html
xlink[HTTP协议 (二) 基本认证]http://www.cnblogs.com/TankXiao/archive/2012/09/26/2695955.html
xlink[HTTP协议 (三) 压缩]http://www.cnblogs.com/TankXiao/archive/2012/11/13/2749055.html
xlink[HTTP协议 (四) 缓存]http://www.cnblogs.com/TankXiao/archive/2012/11/28/2793365.html
xlink[HTTP协议 (五) 代理]http://www.cnblogs.com/TankXiao/archive/2012/12/12/2794160.html
xlink[HTTP协议 (六) 状态码详解]http://www.cnblogs.com/TankXiao/archive/2013/01/08/2818542.html
xlink[HTTP协议 (七) Cookie]http://www.cnblogs.com/TankXiao/archive/2013/04/15/2848906.html


rlink[HTTP协议详解]http://www.cnblogs.com/TankXiao/archive/2012/02/13/2342672.html